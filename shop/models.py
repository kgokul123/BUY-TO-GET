...
class Product(models.Model):
    ...
    product_image = models.URLField(upload_to='products/images/', blank=True, null=True)
...
class ProductImage(models.Model): 
    ...
    image = models.URLField(upload_to='products/images/', blank=True, null=True)
    video = models.URLField(upload_to='products/videos/', blank=True, null=True)
    def __str__(self):
